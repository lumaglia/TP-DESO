...
El backend y el frontend deben ejecutarse en paralelo, cada uno en su propio proceso. El frontend quedará disponible desde un navegador web, generalmente en http://localhost:3000.
